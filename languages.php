...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Languages' | Mwaani Boys' High School</title>  
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Languages<span class="m_1">Below are the Kiswahili and English</span></h1>
		</div>
	</div>
            ...
            <div class="row"> 
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="course-item">
						...
						<div class="course-meta-bot">
							<ul>
								<li><i class="fa fa-calendar" aria-hidden="true"></i> 1 Year</li>
								<li><i class="fa fa-users" aria-hidden="true"></i> 17000 Student</li>
								<li><i class="fa fa-book" aria-hidden="true"></i> 15 Books</li>
							</ul>
						</div>
					</div>
                </div><!-- end col -->
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="course-item">
						...
						<div class="course-br">
							<div class="course-title">
								<h2><a href="#" title="">Kiswahili</a></h2>
							</div>
							<div class="blog-desc">
								<p>Lorem ipsum door sit amet, fugiat deicata avise id cum, no quo maiorum intel ogrets geuiat operts elicata libere avisse id cumlegebat, liber regione eu sit.... </p>
							</div>
						...
						<div class="course-meta-bot">
							<ul>
								<li><i class="fa fa-calendar" aria-hidden="true"></i> 1 Year</li>
								<li><i class="fa fa-users" aria-hidden="true"></i> 17000 Student</li>
								<li><i class="fa fa-book" aria-hidden="true"></i> 20 Books</li>
							</ul>
						</div>
					</div>
                </div><!-- end col -->	
