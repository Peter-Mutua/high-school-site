...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=4">
     ...
     <!-- Site Metas -->
    <title>Sciences | Mwaani Boys' High School</title>  
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Sciences'<span class="m_1">Below are the scince courses that we offer at our school as.</span></h1>
		</div>
	</div>
    ...
    <div id="overviews" class="section wb">
        <div class="container">
            ...
            <div class="row"> 
                <div class="col-lg-3 col-md-6 col-42">
                    <div class="course-item">
						...
						<div class="course-meta-bot">
							<ul>
								<li><i class="fa fa-calendar" aria-hidden="true"></i> 4 Year</li>
								<li><i class="fa fa-users" aria-hidden="true"></i> 47000 Student</li>
								<li><i class="fa fa-book" aria-hidden="true"></i> 200 Books</li>
							</ul>
						</div>
					</div>
                </div><!-- end col -->
                ...
                <div class="col-lg-3 col-md-6 col-42">
                    <div class="course-item">
						...
						<div class="course-br">
							<div class="course-title">
								<h2><a href="#" title="">Mathematics</a></h2>
							</div>
							<div class="blog-desc">
								<p>Lorem ipsum door sit amet, fugiat deicata avise id cum, no quo maiorum intel ogrets geuiat operts elicata libere avisse id cumlegebat, liber regione eu sit.... </p>
							</div>
						...
						<div class="course-meta-bot">
							<ul>
								<li><i class="fa fa-calendar" aria-hidden="true"></i> 4 Year</li>
								<li><i class="fa fa-users" aria-hidden="true"></i> 47000 Student</li>
								<li><i class="fa fa-book" aria-hidden="true"></i> 300 Books</li>
							</ul>
						</div>
					</div>
                </div><!-- end col -->	
				...
				<div class="col-lg-3 col-md-6 col-42">
                    <div class="course-item">
						...
						<div class="course-br">
							<div class="course-title">
								<h2><a href="#" title="">Chemistry</a></h2>
							</div>
							<div class="course-desc">
								<p>Lorem ipsum door sit amet, fugiat deicata avise id cum, no quo maiorum intel ogrets geuiat operts elicata libere avisse id cumlegebat, liber regione eu sit.... </p>
							</div>
				...
				<div class="col-lg-3 col-md-6 col-42">
                   <div class="course-item">
						...
						<div class="course-meta-bot">
							<ul>
								<li><i class="fa fa-calendar" aria-hidden="true"></i> 4 Years</li>
								<li><i class="fa fa-users" aria-hidden="true"></i> 17000 Student</li>
								<li><i class="fa fa-book" aria-hidden="true"></i> 7 Books</li>
							</ul>
						</div>
					</div>
